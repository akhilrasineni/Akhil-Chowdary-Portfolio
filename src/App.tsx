...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <main className="">
        <Hero />
        <section className="bg-white my-10 sm:my-16 h-20 sm:h-32 overflow-hidden">
        ...
        {/* Projects Section */}
        <section id="projects" className="py-20 px-6 bg-[#f0f0f0] relative">
            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
                <div>
                  ...
                  <h3 className="text-4xl sm:text-5xl md:text-8xl font-display font-bold tracking-tighter text-black">
                    FEATURED <br /> 
        ...
        {/* Experience Section */}
        <section id="experience" className="py-20 px-6 bg-[#f0f0f0]">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h3 className="text-4xl sm:text-5xl md:text-7xl font-display font-bold mb-16 md:mb-20 tracking-tighter text-gray-900">A little bit <br /> about me</h3>
            </motion.div>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-20 px-6 relative overflow-hidden bg-black text-white border-t-4 border-white">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <h3 className="text-4xl sm:text-5xl md:text-9xl font-display font-bold mb-12 tracking-tighter text-transparent stroke-text" style={{ WebkitTextStroke: "2px white" }}>
                Get In Touch.
              </h3>
              <a 
      ...
      <footer className="py-12 px-6 border-t-4 border-white bg-black text-white">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm font-bold text-white/60">
